...
- [ ] Explain what a token is used for.
      A token is used to recognize a user successfully logged in to your app with the correct username and password and is now able to navigate throughout your app.
- [ ] What steps can you take in your web apps to keep your data secure?
      Besides issuing a token when a user logs in and destroying it when he logs out or after a period of inactivity, you can use protected routes to make sure a user can also interact with your app if the token is attached to every request.
- [ ] Describe how web servers work.
      Web Servers are both the physical computers that store data and the programs run inside those computers that server the data a user requests.
